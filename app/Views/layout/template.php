...
<head>
  ...
  <title>Membangun Desa Mandiri</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="/mandiri.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="/mandiri.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url('/table'); ?>" class="nav-link <?= (uri_string() == 'table') ? 'active' : ''; ?>">
              <p>
                Table
              </p>
            </a>
